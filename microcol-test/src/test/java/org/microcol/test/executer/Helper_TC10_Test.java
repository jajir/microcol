...
import org.microcol.test.TC_10_famine_will_plague_colony_test;

public class Helper_TC10_Test {
	...
	LauncherDiscoveryRequest request = LauncherDiscoveryRequestBuilder.request()
		.selectors(selectClass(TC_10_famine_will_plague_colony_test.class)).build();
