...
import org.microcol.test.TC_03_declare_independence_test;

public class Helper_TC03_Test {


    @Test
    @Tag("wrapper")
    void start_TC03_test() throws Exception {
	SummaryGeneratingListener listener = new SummaryGeneratingListener();
	LauncherDiscoveryRequest request = LauncherDiscoveryRequestBuilder.request()
		.selectors(selectClass(TC_03_declare_independence_test.class)).build();
