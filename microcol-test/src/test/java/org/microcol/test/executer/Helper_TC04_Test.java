...
import org.microcol.test.TC_04_loosing_battle_test;

public class Helper_TC04_Test {


    @Test
    @Tag("local")
    void start_TC04_test() throws Exception {
	SummaryGeneratingListener listener = new SummaryGeneratingListener();
	LauncherDiscoveryRequest request = LauncherDiscoveryRequestBuilder.request()
		.selectors(selectClass(TC_04_loosing_battle_test.class)).build();
