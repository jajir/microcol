...
public class AnimatinPartWalkTest {
	...
	public void test_first_steps() throws Exception {
		...
		// List<Location> path = Arrays.asList(Location.of(1, 2), Location.of(2,
		// 2));
		// Capture<WhatToDoWithPointInPath> capturedLambda = new Capture<>();
		// pathPlanning.paintPath(EasyMock.eq(Point.of(35, 70)),
		// EasyMock.eq(Point.of(70, 70)),
		// EasyMock.and((WhatToDoWithPointInPath)
		// EasyMock.capture(capturedLambda),
		...
		//
		// assertTrue("first animation step should be available",
		// wa.isNextAnimationLocationAvailable());
		// /**
	...
	public void test_multi_tiles_steps() throws Exception {
		...
		// }
		//
		// assertFalse("Animation step should not be available",
		// wa.isNextAnimationLocationAvailable());
		//
		// /**
