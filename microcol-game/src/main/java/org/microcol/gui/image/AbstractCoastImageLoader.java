...
public abstract class AbstractCoastImageLoader implements ImageLoader {
    ...
    public void preload(final ImageProvider imageProvider) {
        ...
        imageProvider.registerImage(getTypePrefix() + "well",
                getImgInRow(imageProvider, "0").get());

        // U-shape
        addCycle(imageProvider, "u-shapeNorth-", "u-shapeEast-", "u-shapeSouth-", "u-shapeWest-",
                '0', '3', getImgInRow(imageProvider, "1"));
        addCycle(imageProvider, "u-shapeNorth-", "u-shapeEast-", "u-shapeSouth-", "u-shapeWest-",
                '0', '2', getImgInRow(imageProvider, "2"));
        addCycle(imageProvider, "u-shapeNorth-", "u-shapeEast-", "u-shapeSouth-", "u-shapeWest-",
                '1', '3',
                getImg(imageProvider, getTypePrefix() + "u-shapeNorth-02").getImageReverseRows());
        addCycle(imageProvider, "u-shapeNorth-", "u-shapeEast-", "u-shapeSouth-", "u-shapeWest-",
                '1', '2', getImgInRow(imageProvider, "3"));

        // L-shape
        addCycle(imageProvider, "l-shapeSouthEast-", "l-shapeSouthWest-", "l-shapeNorthWest-",
                "l-shapeNorthEast-", '3', '9', getImgInRow(imageProvider, "4"));
        addCycle(imageProvider, "l-shapeSouthEast-", "l-shapeSouthWest-", "l-shapeNorthWest-",
                "l-shapeNorthEast-", '2', '9', getImgInRow(imageProvider, "5"));
        addCycle(imageProvider, "l-shapeSouthEast-", "l-shapeSouthWest-", "l-shapeNorthWest-",
                "l-shapeNorthEast-", '3', 'a',
                getImg(imageProvider, getTypePrefix() + "l-shapeSouthEast-29").getImageTranspose());
        addCycle(imageProvider, "l-shapeSouthEast-", "l-shapeSouthWest-", "l-shapeNorthWest-",
                "l-shapeNorthEast-", '2', 'a', getImgInRow(imageProvider, "6"));

        // I-shape
        addCycle(imageProvider, "i-shapeNorth-", "i-shapeEast-", "i-shapeSouth-", "i-shapeWest-",
                '0', '3', getImgInRow(imageProvider, "7"));
        addCycle(imageProvider, "i-shapeNorth-", "i-shapeEast-", "i-shapeSouth-", "i-shapeWest-",
                '0', '4', getImgInRow(imageProvider, "8"));
        addCycle(imageProvider, "i-shapeNorth-", "i-shapeEast-", "i-shapeSouth-", "i-shapeWest-",
                'b', '3',
                getImg(imageProvider, getTypePrefix() + "i-shapeNorth-04").getImageReverseRows());
        addCycle(imageProvider, "i-shapeNorth-", "i-shapeEast-", "i-shapeSouth-", "i-shapeWest-",
                'b', '4', getImgInRow(imageProvider, "9"));
    ...
    private void generateII_shape(final ImageProvider imageProvider, final Connector start,
            final Connector end) {
        ...
        TileDef.of(name1, Connector.of('6'), Connector.of('9'),
                getImg(imageProvider, imagName)
                        .addImage(getImg(imageProvider, getTypePrefix() + "i-shapeSouth-69")))
                .storeTo(imageProvider).rotateRight(name2).storeTo(imageProvider);
        TileDef.of(name1, Connector.of('5'), Connector.of('9'),
                getImg(imageProvider, imagName)
                        .addImage(getImg(imageProvider, getTypePrefix() + "i-shapeSouth-59")))
                .storeTo(imageProvider).rotateRight(name2).storeTo(imageProvider);
        TileDef.of(name1, Connector.of('6'), Connector.of('a'),
                getImg(imageProvider, imagName)
                        .addImage(getImg(imageProvider, getTypePrefix() + "i-shapeSouth-6a")))
                .storeTo(imageProvider).rotateRight(name2).storeTo(imageProvider);
        TileDef.of(name1, Connector.of('5'), Connector.of('a'),
                getImg(imageProvider, imagName)
                        .addImage(getImg(imageProvider, getTypePrefix() + "i-shapeSouth-5a")))
                .storeTo(imageProvider).rotateRight(name2).storeTo(imageProvider);
    }

    private void addCycle(final ImageProvider imageProvider, final String direction1,
        ...
        TileDef.of(dir1, Connector.of(start), Connector.of(end), imageWrapper)
                .storeTo(imageProvider).rotateRight(dir2).storeTo(imageProvider).rotateRight(dir3)
                .storeTo(imageProvider).rotateRight(dir4).storeTo(imageProvider);
    }
