...
public class PanelDockCratesController {

	private final PanelDockCratesView panelCratesView;

	PanelDockCratesController(final ImageProvider imageProvider, final PanelDockBehavior panelDockBehavior) {
		this.panelCratesView = new PanelDockCratesView(Preconditions.checkNotNull(imageProvider), panelDockBehavior);
	}
