...
public class ClipboardReader {
    ...
    private TransferFromCargoSlot tryReadTransferFromCargoSlot(int fromIndex) {
        ...
        return new TransferFromCargoSlot(model.getUnitById(read(parts[fromIndex + 1])),
    ...
    private TransferFromColonyField tryReadTransferFromColonyField(int fromIndex) {
        ...
        return new TransferFromColonyField(
    ...
    public class ParsingResult {
        ...
        public ParsingResult readUnit(final BiConsumer<Unit, Optional<TransferFrom>> consumer) {
            if (unitTransfer == null) {
                throw new IllegalStateException(
                        "Unable to read unit from string '" + originalString + "'");
            } else {
                consumer.accept(unitTransfer.unit, unitTransfer.getTransferFrom());
                return this;
            }
        ...
        public ParsingResult tryReadGood(
                final BiConsumer<GoodsAmount, Optional<TransferFrom>> consumer) {
            if (goodTransfer != null) {
        ...
        public ParsingResult readGood(
                final BiConsumer<GoodsAmount, Optional<TransferFrom>> consumer) {
            if (goodTransfer == null) {
                throw new IllegalStateException(
                        "Unable to read good from string '" + originalString + "'");
            } else {
                consumer.accept(goodTransfer.goodsAmount, goodTransfer.getTransferFrom());
                return this;
            }
