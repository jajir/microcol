...
public final class MainMenuView {
    ...
    public MainMenuView(final GamePreferences gamePreferences, final Text text,
        ...
        gamePreferences.getShowFightAdvisorProperty()
                .bindBidirectional(menuItemShowFightAdvisor.selectedProperty());
        ...
        menuUnit = new Menu();
        menuUnit.getItems().addAll(menuItemMove, menuItemBuildColony, menuItemPlowField,
                menuItemNextUnit);
        menuPrefereces = new Menu();
        menuPrefereces.getItems().addAll(menuLanguage, menuItemVolume, menuItemAnimationSpeed,
