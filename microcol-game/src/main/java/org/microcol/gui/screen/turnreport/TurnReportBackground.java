...
public class TurnReportBackground extends AbstractAnimatedBackground {

    private final static String IMG_BACKGROUND = "background-wood2.png";

    private final static String IMG_PAPER = "page.png";
    ...
    @Inject
    public TurnReportBackground(final ImageProvider imageProvider) {
