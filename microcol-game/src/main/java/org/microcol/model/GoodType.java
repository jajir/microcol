...
public class GoodType {
	...
	public final static GoodType CORN = GoodTypeBuilder.make()
			.setName("CORN")
			.setCanBeBought(true)
			.build();

	public final static GoodType SUGAR = GoodTypeBuilder.make()
			.setName("SUGAR")
			.setCanBeBought(true)
			.build();
	...
	public final static GoodType COTTON = GoodTypeBuilder.make()
			.setName("COTTON")
			.setCanBeBought(true)
			.build();

	public final static GoodType FUR = GoodTypeBuilder.make()
			.setName("FUR")
			.setCanBeBought(true)
			.build();

	public final static GoodType LUMBER = GoodTypeBuilder.make()
			.setName("LUMBER")
			.setCanBeBought(true)
			.build();

	public final static GoodType ORE = GoodTypeBuilder.make()
			.setName("ORE")
			.setCanBeBought(true)
			.build();

	public final static GoodType SILVER = GoodTypeBuilder.make()
			.setName("SILVER")
			.setCanBeBought(true)
			.build();

	public final static GoodType HORSE = GoodTypeBuilder.make()
			.setName("HORSE")
			.setCanBeBought(true)
			.build();

	public final static GoodType RUM = GoodTypeBuilder.make()
			.setName("RUM")
			.setCanBeBought(true)
			.build();

	public final static GoodType CIGARS = GoodTypeBuilder.make()
			.setName("CIGARS")
			.setCanBeBought(true)
			.build();

	public final static GoodType SILK = GoodTypeBuilder.make()
			.setName("SILK")
			.setCanBeBought(true)
			.build();

	public final static GoodType COAT = GoodTypeBuilder.make()
			.setName("COAT")
			.setCanBeBought(true)
			.build();

	public final static GoodType GOODS = GoodTypeBuilder.make()
			.setName("GOODS")
			.setCanBeBought(true)
			.build();

	public final static GoodType TOOLS = GoodTypeBuilder.make()
			.setName("TOOLS")
			.setCanBeBought(true)
			.build();

	public final static GoodType MUSKET = GoodTypeBuilder.make()
			.setName("MUSKET")
			.setCanBeBought(true)
			.build();

	public final static GoodType HAMMERS = GoodTypeBuilder.make()
			.setName("HAMMERS")
			.setCanBeBought(false)
			.build();

	public final static GoodType CROSS = GoodTypeBuilder.make()
			.setName("CROSS")
			.setCanBeBought(false)
			.build();

	public final static GoodType BELL = GoodTypeBuilder.make()
			.setName("BELL")
			.setCanBeBought(false)
			.build();
