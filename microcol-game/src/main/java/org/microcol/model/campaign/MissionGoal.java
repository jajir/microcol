...
public abstract class MissionGoal {
     ...
     */
    private final Missions descriptionKey;
    ...
    MissionGoal(final String name, final Missions descriptionKey, final Map<String, String> data) {
     ...
     */
    public Missions getDescriptionKey() {
