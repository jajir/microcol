...
public interface Campaign {
	...
	/**
	 * Inform if player finished this campaign. Player finish campaign when finish
	 * all missions.
	 *
	...
	/**
	 * Return if user could start given mission. Mission could be started when was
	 * already finished or when is next after already finished mission.
	 *
	 * @param mission
