...
public final class GameOverEvaluator {
	...
	public GameOverEvaluator(final List<Function<Model, GameOverResult>> gameOverEvaluators) {
		...
		Preconditions.checkArgument(!gameOverEvaluators.isEmpty(), "Game over evaluators are empty.");
	...
	public static final Function<Model, GameOverResult> GAMEOVER_CONDITION_HUMAN_LOST_ALL_COLONIES = (model) -> {
